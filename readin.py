...
def readin_SNrest(filename):
    ...
    data = np.recfromtxt("/Users/zaidi/Documents/REU/restframe/"+"SN1990Y.rest.dat",usecols = (0,1,2,3,4,5,6), dtype = formatcode, names = True, skip_header = 13, case_sensitive = 'lower', invalid_raise = False)
